...
function createScoreLabel({score = 100, object}) {
    ...
    scoreLabel.innerHTML = scoreLabel
...
function animate() {
    ...
    for ( let i = projectile.length - 1; i >= 0; i-- ) {
        ...
        for ( let j = 0; j >= projectile.length; j--) {
            ...
            //if projectile touches bomb, remove the projectile
            if (
                Math.hypot(
    ...
    grids.forEach((grid, gridIndex) => {
        ...
        for (let i = grid.invaders.length -1; i>=0; i--) {
            ...
            for (let j = bombs.length - 1; j >= 0; j--) {
                ...
                // if bomb touches invader, remove the invader
                if (
                    Math.hypot(
            ...
            projectiles.forEach((projectile, j) => {
                if (
                    ...
                    setTimeout(() => {
                        ...
                        //remove the projectile and the invader
            ...
            //if invaders touch the player, remove the Player
            if (
                rectangularCollision({
                    rectangle1: invader,
                    rectangle2: player
